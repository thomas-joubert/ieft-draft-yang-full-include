...
if __name__ == '__main__':
    ...
    output = os.path.join(os.path.dirname(BUILDER_DIR), f"draft-blaise-yang-full-include-{version:02}.xml")
    draft_text = env.get_template("draft-blaise-yang-full-include.xml")
